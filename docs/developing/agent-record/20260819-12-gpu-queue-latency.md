...
description: Tracking a frozen viewport down to GPU queue latency rather than batch size.
icon: material/note-text-outline
status: ai-generated
model: claude-opus-5 (Claude Code)
issue: none
state: complete — root cause measured, fix implemented and verified in the running app
