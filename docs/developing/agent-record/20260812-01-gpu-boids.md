...
description: Building gpu_boids, and the shared GPU machinery two agent models needed.
...
state: partial — gpu_ants and the GpuAgentModel extraction are NOT started
