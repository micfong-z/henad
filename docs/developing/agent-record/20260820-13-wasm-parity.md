...
description: Bringing GPU models and a real thread pool to the browser build.
icon: material/note-text-outline
status: ai-generated
model: claude-opus-5 (Claude Code)
issue: 12
state: stages 0-3 complete — 0 to 2 committed and verified in a browser, stage 3 awaiting review
