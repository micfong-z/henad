...
description: Adding naming and American-English spelling rules, and applying them to code identifiers.
...
state: complete — rules written, identifier/string/WGSL violations fixed, comments left British
