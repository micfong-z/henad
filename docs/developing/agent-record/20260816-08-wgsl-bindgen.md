...
description: Generating the WGSL and Rust seam with wgsl_bindgen, and resolving bindings by name.
icon: material/note-text-outline
status: ai-generated
model: claude-opus-5 (Claude Code)
issue: "#33, under #10"
state: complete — stages 1–7 landed, one stage measured and reverted, name resolution added on top
